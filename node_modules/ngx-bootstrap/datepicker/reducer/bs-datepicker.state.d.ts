import { DatepickerFormatOptions, DatepickerRenderOptions, DaysCalendarModel, MonthViewModel, MonthViewOptions } from '../models/index';
export declare class BsDatepickerState {
    viewDate: Date;
    hoveredDate?: Date;
    selectedDate?: Date;
